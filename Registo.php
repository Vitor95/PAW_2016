<html>
	...
	<div class="element-select"><label class="title">Perfil<span class="required">*</span></label><div class="item-cont"><div class="large"><span>
        ...
        <div id="fto" style="display: none"><label class="title">Foto:<span class="required">*</span></label><div class="item-cont"><input class="large" type="text" value="none" name="foto" required="required" placeholder="Input Text"/><span class="icon-place"></span></div></div>
