    ...
    <body>
        ...
        <div class="container">
            ...
            <form action="Validations/validAddEmpPre.php" method="post">
                ...
                <label>username<input placeholder="username" type="text" name="username"></label><br>
...
$select = mysql_select_db("tp_paw") or die("Sem acesso ao DB, Entre em contato com o Administrador");
            $query_select = "SELECT * FROM utilizador where perfil= 'empregador'";
